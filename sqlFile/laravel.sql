...
--
-- Hôte : db
-- Généré le : mar. 25 juin 2024 à 08:09
...
ALTER TABLE `groupes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `groupes_categorie_id_foreign` (`categorie_id`);
...
ALTER TABLE `questions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `questions_groupe_id_foreign` (`groupe_id`);
...
ALTER TABLE `reponses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `reponses_entreprise_id_foreign` (`entreprise_id`),
